...
class CorrosionDisplay:
    def __init__(
        ...
        self._image_group = displayio.Group(max_size=18)
        ...
        self._title = Label(FONT_1, text="Interior", color=self.CYAN, max_glyphs=8)
        ...
        self._temperature = Label(
            FONT_3, text="  0.0" + "°", color=self.WHITE, max_glyphs=6
        )
        ...
        self._humidity = Label(FONT_2, text="  0%", color=self.WHITE, max_glyphs=4)
        ...
        self._clock_digits = Label(
            CLOCK_FONT, text="12:00", color=self.WHITE, max_glyphs=5
        )
        ...
        self._clock_day_mon_yr = Label(
            FONT_1, text="Sun  Jan 01, 1970", color=self.WHITE, max_glyphs=17
        )
        ...
        self._project_message = Label(FONT_1, text="", color=self.YELLOW, max_glyphs=20)
        ...
        self._status = Label(FONT_3, text="!", color=None, max_glyphs=1)
        ...
        self._pcb_temp = Label(
            FONT_1, text="  0.0" + "°", color=self.CYAN, max_glyphs=6
        )
